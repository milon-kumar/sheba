...
```
cd existing_repo
git remote add origin https://gitlab.com/Himel-Sarker/sheba-medical-center.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Himel-Sarker/sheba-medical-center/-/settings/integrations)
